...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("syrria")
                await self.one.join_chat("cca6a")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("CCA6A")
                await self.two.join_chat("syrria")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("CCA6A")
                await self.three.join_chat("SYRRIIA")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("SYRRIA")
                await self.four.join_chat("CCA6A")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("SYRRIIA")
                await self.five.join_chat("CCA6A")
            except:
                pass
            assistants.append(5)
